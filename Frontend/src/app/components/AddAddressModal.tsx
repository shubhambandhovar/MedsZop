...
export function AddAddressModal({ isOpen, onClose, onAddAddress, language }: AddAddressModalProps) {
  ...
  const handleAddAddress = () => {
    ...
    toast.success(language === 'en' ? 'Address added successfully!' : 'पता सफलतापूर्वक जोड़ा गया!');
